    ...
    namespace Event
    {
        ...
        namespace Input
        {
            class Mouse
            {
                ...
                Math::Vector2 GetViewportCoords() { return m_viewportPos; }
            ...
            private:
                ...
                void SetViewportCoords(Math::Vector2 const& a_position) { m_viewportPos = a_position; }
