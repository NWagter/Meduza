...
void Me::Renderer::Dx12::CommandList::Draw(Resources::Dx12::Mesh* a_mesh, DrawOutput& a_drawOutput)
{
	...
	a_drawOutput.m_vertices = a_mesh->GetVerticesSize();
}

void Me::Renderer::Dx12::CommandList::Draw(Resources::Dx12::Mesh* a_mesh, ID3D12Resource* a_heaps, int const a_count, DrawOutput& a_drawOutput)
{
